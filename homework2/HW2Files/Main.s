...
!   Next value...
	...
	store	r1,[r14+-40]
_Label_575:
!   Data Move: *_temp_573 = 0  (sizeInBytes=1)
	mov	0,r1
	load	[r14+-44],r2
	storeb	r1,[r2]
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if bufferLength != 4 then goto _Label_598		(int)
	load	[r14+8],r1
	load	[r1+24],r1
	mov	4,r2
	cmp	r1,r2
...
!   _temp_601 = &buffer
	...
	add	r1,4,r1
	store	r1,[r14+-72]
!   Move address of _temp_601 [bufferLength ] into _temp_602
!     make sure index expr is >= 0
	load	[r14+8],r2
	load	[r2+24],r2
	cmp	r2,0
...
!   _temp_610 = 1		(4 bytes)
	...
	store	r1,[r14+-52]
!   Calculate and save the FOR-LOOP ending value
!   _temp_611 = bufferLength		(4 bytes)
	load	[r14+8],r1
	load	[r1+24],r1
	store	r1,[r14+-48]
!   Initialize FOR-LOOP index variable
...
!   _temp_613 = &buffer
	...
	add	r1,4,r1
	store	r1,[r14+-44]
!   Move address of _temp_613 [j ] into _temp_614
!     make sure index expr is >= 0
	load	[r14+-92],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-40]
!   Data Move: _temp_612 = *_temp_614  (sizeInBytes=1)
	load	[r14+-40],r1
	loadb	[r1],r1
	storeb	r1,[r14+-9]
!   Prepare Argument: offset=8  value=_temp_612  sizeInBytes=1
	loadb	[r14+-9],r1
	storeb	r1,[r15+0]
!   Call the function
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if bufferLength != 1 then goto _Label_623		(int)
	load	[r14+8],r1
	load	[r1+24],r1
	mov	1,r2
	cmp	r1,r2
	bne	_Label_623
!	_Label_622	jmp	_Label_622
_Label_622:
! THEN...
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if intIsZero (bufferLength) then goto _Label_652
	load	[r14+8],r1
	load	[r1+24],r1
	cmp	r1,r0
	be	_Label_652
...
!   _temp_656 = &buffer
	...
	add	r1,4,r1
	store	r1,[r14+-72]
!   Move address of _temp_656 [0 ] into _temp_657
!     make sure index expr is >= 0
	mov	0,r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-68]
!   Data Move: c = *_temp_657  (sizeInBytes=1)
	load	[r14+-68],r1
	loadb	[r1],r1
	storeb	r1,[r14+-10]
! ASSIGNMENT STATEMENT...
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if bufferLength != 3 then goto _Label_659		(int)
	load	[r14+8],r1
	load	[r1+24],r1
	mov	3,r2
	cmp	r1,r2
	bne	_Label_659
!	_Label_658	jmp	_Label_658
_Label_658:
! THEN...
...
!   if intIsZero (_P_Thread_currentThread) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   _temp_664 = _P_Thread_currentThread + 72
	set	_P_Thread_currentThread,r1
	load	[r1],r1
	add	r1,72,r1
	store	r1,[r14+-48]
...
!   _temp_669 = 1		(4 bytes)
	...
	store	r1,[r14+-44]
!   Calculate and save the FOR-LOOP ending value
!   _temp_670 = bufferLength		(4 bytes)
	load	[r14+8],r1
	load	[r1+24],r1
	store	r1,[r14+-40]
!   Initialize FOR-LOOP index variable
...
!   _temp_672 = &buffer
	...
	add	r1,4,r1
	store	r1,[r14+-36]
!   Move address of _temp_672 [j ] into _temp_673
!     make sure index expr is >= 0
	load	[r14+-92],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-32]
!   Data Move: _temp_671 = *_temp_673  (sizeInBytes=1)
	load	[r14+-32],r1
	loadb	[r1],r1
	storeb	r1,[r14+-9]
!   Prepare Argument: offset=8  value=_temp_671  sizeInBytes=1
	loadb	[r14+-9],r1
	storeb	r1,[r15+0]
!   Call the function
